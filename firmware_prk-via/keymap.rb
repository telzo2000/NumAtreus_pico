...
kbd.add_layer :default, %i[
  ...
  KC_LSFT KC_LGUI KC_LCTL     KC_LALT   VIA_FUNC0    KC_SPACE  VIA_FUNC1   KC_1     KC_2      KC_3     KC_BSPACE
]
kbd.add_layer :number, %i[
  ...
  KC_LSFT KC_LGUI KC_LCTL     KC_LALT   VIA_FUNC0    KC_SPACE  KC_0   KC_1     KC_2      KC_3     KC_BSPACE
]
...
kbd.define_mode_key_via :VIA_FUNC0,   [ :KC_SPACE,             :VIA_LAYER1,                     150,              150 ]
kbd.define_mode_key_via :VIA_FUNC1,   [ :KC_X,                 :KC_LGUI,                     150,              150 ]
